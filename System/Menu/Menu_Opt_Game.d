...
INSTANCE MENUITEM_GAME_SUB_TITLES(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"字 幕";
	text[1]		= 	"切 换 在 对 话 时 的 字 幕 开 ／ 关"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GAME_FIGHTFOCUS(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"战 斗 焦 点";
	text[1]		= 	"设 定 高 亮 现 显 示 前 战 斗 目 标"; // Kommentar
	// Position und Dimension	
	posx		=	1000;	posy		=	MENU_START_Y + MENU_SOUND_DY*1;
	dimx		=	4000;	dimy		=	750;
	// Aktionen
...
INSTANCE MENUITEM_GAME_INTERACTFOCUS(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"物 体 焦 点";
	text[1]		= 	"切 换 高 亮 显 示 瞄 准 的 物 体"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GAME_LOOKAROUND_INVERSE(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"翻 转 镜 头";
	text[1]		= 	"切 换 翻 转 摄 像 机 镜 头 移 动 开 ／ 关"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"哥 特 王 朝 Ｉ 控 制";
	text[1]		= 	"使 用 哥 特 王 朝 Ｉ 的 战 斗 控 制"; // Kommentar
	// Position und Dimension	
