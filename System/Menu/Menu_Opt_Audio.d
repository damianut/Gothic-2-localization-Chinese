...
INSTANCE MENUITEM_AUDIO_SFXVOL(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "特 效 音 量";
	text[1]		= "声 音 效 果 和 语 音 音 量"; // Kommentar
...
instance MENUITEM_AUDIO_MUSIC(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "音 乐 开/关";
	text[1]		= "切 换 背 景 音 乐 开 ／ 关 。"; // Kommentar
...
instance MENUITEM_AUDIO_PROVIDER(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "声 音 提 供 器";
	text[1]		= "你 需 要 重 新 启 动 让 改 变 生 效 。"; // Kommentar
...
instance MENUITEM_AUDIO_SPEEKER_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		=   "2声 道 喇 叭 ｜ 耳 机 ｜ 环 绕 ｜4声 道 喇 叭 ｜5．1声 道 喇 叭 ｜7．1声 道 喇 叭";
	fontName	= 	MENU_FONT_SMALL;
	// Position und Dimension
...
instance MENUITEM_AUDIO_REVERB(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "环 境 回 音";
	text[1]		= "在 山 洞 中 等 环 境 回 音 效 果 等 等"; // Kommentar
...
instance MENUITEM_AUDIO_SAMPLERATE(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "采 样 率";
	text[1]		= "你 需 要 重 新 启 动 以 使 改 变 生 效 。"; // Kommentar
