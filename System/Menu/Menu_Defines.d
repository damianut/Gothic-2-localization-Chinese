...
//
	...
	const string CTRL_KEYDEF	  = "按 Ｄ Ｅ Ｌ 键 清 空 栏 位 ， 按 Ｅ ｎ ｔ ｅ ｒ 进 行 设 定";
	const string CTRL_KEYDEF_INFO = "请 按 此 动 作 所 需 的 按 键 。";
	const string MENU_NO_YES	  = "否 ｜ 是";
	const string MENU_OFF_ON	  = "关 ｜ 开";
	const string MENU_BACK		  = "返 回";
