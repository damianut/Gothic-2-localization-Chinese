...
INSTANCE MENUITEM_GRA_TEXQUAL(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"贴 图 细 节";
	text[1]		= 	"选 择 贴 图 的 细 节 等 级"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GRA_MODEL_DETAIL(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"模 型 细 节";
	text[1]		= 	"选 择 模 型 的 细 节 等 级"; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_GRA_SIGHT(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "视 距";
	text[1]		= "以 百 分 比 选 择 观 察 的 距 离"; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_VOB_SIGHT(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "物 体 浅 隐";
	text[1]		= "选 择 物 体 从 视 野 中 淡 出 的 距 离"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GRA_SKY_EFFECTS(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"天 空 效 果";
	text[1]		= 	"切 换 同 年 空 效 果 开 ／ 关"; // Kommentar
	// Position und Dimension	
