...
INSTANCE MENUITEM_OPT_GRAPHICS(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "视 觉 设 置";
	text[1]		= "视 线 的 距 离 、 细 节 和 效 果 。";  // Kommentar
...
instance MENUITEM_OPT_VIDEO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		=	"图 像 设 置";
	text[1]		=	"图 形 卡 、 分 辨 率 、 亮 度 和 对 比 度";  // Kommentar
...
INSTANCE MENUITEM_OPT_AUDIO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "音 频 设 置";
	text[1]		= "音 乐 、 语 音 和 声 音 效 果";  // Kommentar
...
INSTANCE MENUITEM_OPT_CONTROLS(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "控 制";
	text[1]		= "设 定 键 盘 和 鼠 标";  // Kommentar
...
INSTANCE MENUITEM_PERF(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "性 能 ／ 品 质";
	text[1]		= "优 化 你 的 性 能 和 品 质";  // Kommentar
...
instance MENUITEM_PERF_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "定 制#高 性 能 ｜ 中 等 性 能 ｜ 高 品 质";	// # trennt die UnDef-Option von der auswaehlbaren Optionen
