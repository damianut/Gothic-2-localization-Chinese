...
func void StoryHelper_INFO1_Info()
{
	...
	Info_AddChoice(StoryHelper_INFO1, "ø®∆§Ãÿ¿º∑º", StoryHelper_KAPITEL1ANFANG);
	Info_AddChoice(StoryHelper_INFO1, "≤Âº˛ ◊º±∏”Î»¯Õº¿≠Àπµ⁄“ª¥Œª·√Ê£®Õ¸º«¿≠¿◊Àπ£©", StoryHelper_SATURAS);
	Info_AddChoice(StoryHelper_INFO1, "≤Âº˛ø®Õþ¬°¥ÌŒÛ ", StoryHelper_Cavalorn);
};
...
func void StoryHelper_INFO2_Info()
{
	...
	Info_AddChoice(StoryHelper_INFO2, "ø®∆§Ãÿ¿º∑º", StoryHelper_KAPITEL2ANFANG);
};
...
func void StoryHelper_INFO3_Info()
{
	...
	Info_AddChoice(StoryHelper_INFO3, "ø®∆§Ãÿ¿º∑º", StoryHelper_KAPITEL3ANFANG);
};
...
func void StoryHelper_INFO4_Info()
{
	...
	Info_AddChoice(StoryHelper_INFO4, "ø®∆§Ãÿ¿º∑º", StoryHelper_KAPITEL4ANFANG);
};
...
func void StoryHelper_INFO5_Info()
{
	...
	Info_AddChoice(StoryHelper_INFO5, "ø®∆§Ãÿ¿º∑º", StoryHelper_KAPITEL5ANFANG);
};
...
func void StoryHelper_INFO6_Info()
{
	...
	Info_AddChoice(StoryHelper_INFO6, "ø®∆§Ãÿ¿º∑º", StoryHelper_KAPITEL6ANFANG);
};
