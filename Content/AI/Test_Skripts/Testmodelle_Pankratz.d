...
instance J4(C_Item)
{
	name						= "ADW_PIRATES_RemovedFocus∫Õ◊Ó∫Û";
...
func void SH_Oldworld_INFO1_Info()
{
	...
	Info_AddChoice(SH_Oldworld_INFO1, "ø®∆§Ãÿ¿º∑º", SH_Oldworld_KAPITEL1ANFANG);
};
...
func void SH_Oldworld_INFO2_Info()
{
	...
	Info_AddChoice(SH_Oldworld_INFO2, "ø®∆§Ãÿ¿º∑º", SH_Oldworld_KAPITEL2ANFANG);
};
...
func void SH_Oldworld_INFO3_Info()
{
	...
	Info_AddChoice(SH_Oldworld_INFO3, "ø®∆§Ãÿ¿º∑º", SH_Oldworld_KAPITEL3ANFANG);
};
...
func void SH_Oldworld_INFO4_Info()
{
	...
	Info_AddChoice(SH_Oldworld_INFO4, "ø®∆§Ãÿ¿º∑º", SH_Oldworld_KAPITEL4ANFANG);
};
...
func void SH_Oldworld_INFO5_Info()
{
	...
	Info_AddChoice(SH_Oldworld_INFO5, "ø®∆§Ãÿ¿º∑º", SH_Oldworld_KAPITEL5ANFANG);
};
...
func void SH_Oldworld_INFO6_Info()
{
	...
	Info_AddChoice(SH_Oldworld_INFO6, "ø®∆§Ãÿ¿º∑º", SH_Oldworld_KAPITEL6ANFANG);
};
...
{
	AI_Output(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //你已经走过了很长的路，小家伙，但你不会活着离开这个大厅。
	AI_Output(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //你已经走过了很长的路，小家伙，但你不会活着离开这个大厅。
	AI_Output(other, self, "DIA_Dragon_Testmodell_Hello_15_00"); //不要这么大惊小怪的。让我们谈点正事吧。
	AI_Output(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //你已经走过了很长的路，小家伙，但你不会活着离开这个大厅。
	AI_Output(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //你已经走过了很长的路，小家伙，但你不会活着离开这个大厅。
	AI_Output(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //你已经走过了很长的路，小家伙，但你不会活着离开这个大厅。
	AI_Output(other, self, "DIA_Dragon_Testmodell_Hello_15_00"); //不要这么大惊小怪的。让我们谈点正事吧。
...
const string JOLY_ITEM1_1 = "测试 Bla Glumpsch、";
...
const string JOLY_ITEM2_1 = "测试 Bla Glumpsch、";
