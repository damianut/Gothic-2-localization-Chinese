...
const string _PRINT_1000_GOLD = "1000黄金。";
const string _PRINT_CHEATER = "◊˜±◊’þ¬Ì¬≥Àπ£∫ -100 æ≠—È÷µ";
func void UseGold()
{
	CreateInvItems(self, ItMi_Gold, 1000);
...
instance EnterBanditCamp(C_Item)
{
	...
	description					= "…Ë÷√Player_HasTalkedToBanditCamp";
	text[0]						= "";											count[0] = 0;
	text[1]						= "";											count[1] = 0;
	text[2]						= "";											count[2] = 0;
	text[3]						= "";											count[3] = 0;
