...
instance ItAt_TalbinsLurkerSkin(C_Item)
{
	...
	description					= name;
	text[0]						= "里 面 印 着 塔 尔 宾 的 名 字 。";	count[0] = 0;
	text[1]						= "";											count[1] = 0;
	text[2]						= "";											count[2] = 0;
	text[3]						= "";											count[3] = 0;
	text[4]						= "";											count[4] = 0;
...
instance ItAt_DragonEgg_MIS(C_ITEM)
{
	...
	description					= name;
	text[0]						= "蛋 仍 然 温 暖";				count[0] = 0;
	text[1]						= "里 面 发 出 抓 挠 的 声 音 。";					count[1] = 0;
	text[2]						= "";											count[2] = 0;
	text[3]						= "";											count[3] = 0;
	text[4]						= "";											count[4] = 0;
	text[5]						= NAME_Value;									count[5] = value;
...
instance ItRi_OrcEliteRing(C_Item)
{
	...
	description					= name;
	text[0]						= "这 个 戒 指 很 粗 糙 ，";			count[0] = 0;
	text[1]						= "似 乎 冰 冷 得 有 些 奇 怪 。";							count[1] = 0;
	text[2]						= "";											count[2] = 0;
	text[3]						= "";											count[3] = 0;
	text[4]						= "";											count[4] = 0;
	text[5]						= NAME_Value;									count[5] = value;
