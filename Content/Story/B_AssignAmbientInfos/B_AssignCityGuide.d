...
func void B_AddCityGuideChoices()
{
	...
	{
		Info_AddChoice(DIA_CITYGUIDE, "去 城 镇 的 贫 民 区 。", DIA_CITYGUIDE_UNTERSTADT);
	};

	if (!C_IsQuarterNearest(self, Q_OBERSTADT))
	{
		Info_AddChoice(DIA_CITYGUIDE, "去 富 人 区 。", DIA_CITYGUIDE_OBERSTADT);
	};

	if (!C_IsQuarterNearest(self, Q_TEMPEL))
	{
		Info_AddChoice(DIA_CITYGUIDE, "去 亚 达 诺 斯 神 殿", DIA_CITYGUIDE_TEMPEL);
	};

	if (!C_IsQuarterNearest(self, Q_MARKT))
	{
		Info_AddChoice(DIA_CITYGUIDE, "去 市 场 。", DIA_CITYGUIDE_MARKT);
	};

	if (!C_IsQuarterNearest(self, Q_GALGEN))
	{
		Info_AddChoice(DIA_CITYGUIDE, "去 绞 刑 广 场", DIA_CITYGUIDE_GALGEN);
	};

	if (!C_IsQuarterNearest(self, Q_KASERNE))
	{
		Info_AddChoice(DIA_CITYGUIDE, "去 兵 营 。", DIA_CITYGUIDE_KASERNE);
	};

	if (!C_IsQuarterNearest(self, Q_HAFEN))
	{
		Info_AddChoice(DIA_CITYGUIDE, "去 海 港 地 区 。", DIA_CITYGUIDE_HAFEN);
	};

	Info_AddChoice(DIA_CITYGUIDE, "谢 谢 - 我 要 知 道 的 就 这 么 多 了 ！", DIA_CITYGUIDE_BACK);
};
...
{
	AI_Output(other, self, "DIA_CITYGUIDE_15_00"); //关 于 这 个 地 区 的 事 你 能 告 诉 我 什 么 ？
...
{
	AI_Output(other, self, "DIA_CITYGUIDE_BACK_15_00"); //谢 谢 - 我 要 知 道 的 就 这 么 多 了 ！
	Info_ClearChoices(DIA_CITYGUIDE);
};

func void DIA_CITYGUIDE_UNTERSTADT()
{
	AI_Output(other, self, "DIA_CITYGUIDE_UNTERSTADT_15_00"); //我 怎 么 去 城 镇 的 贫 民 区 ？
...
{
	AI_Output(other, self, "DIA_CITYGUIDE_OBERSTADT_15_00"); //我 怎 么 去 富 人 区 ？
...
{
	AI_Output(other, self, "DIA_CITYGUIDE_TEMPEL_15_00"); //我 在 找 神 殿 。
...
{
	AI_Output(other, self, "DIA_CITYGUIDE_MARKT_15_00"); //市 场 在 哪 里 ？
...
{
	AI_Output(other, self, "DIA_CITYGUIDE_GALGEN_15_00"); //我 怎 么 去 绞 刑 广 场 ？
...
{
	AI_Output(other, self, "DIA_CITYGUIDE_KASERNE_15_00"); //兵 营 在 哪 里 ？
...
{
	AI_Output(other, self, "DIA_CITYGUIDE_HAFEN_15_00"); //海 港 地 区 在 哪 里 ？
