...
instance DIA_Addon_Telbor_NW_Hi(C_INFO)
{
	...
	description		= "那 么 回 到 地 里 继 续 工 作 ？";
};
...
{
	AI_Output(other, self, "DIA_Addon_Telbor_NW_Hi_15_00"); //那 么 回 到 地 里 继 续 工 作 ？
	AI_Output(self, other, "DIA_Addon_Telbor_NW_Hi_12_01"); //嘿 ， 救 了 我 的 命 的 人 ！ 对 ， 我 现 在 的 工 作 更 繁 重 了 。

	if (!Npc_IsDead(Egill)
	&& !Npc_IsDead(Ehnim))
	{
		AI_Output(self, other, "DIA_Addon_Telbor_NW_Hi_12_02"); //特 别 是 和 那 两 个 傻 兄 弟 一 起 。 哦 ， 老 兄 ， 强 盗 不 是 那 么 糟 … …
	};
};
