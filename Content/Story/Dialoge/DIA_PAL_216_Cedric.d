...
{
	AI_Output(self, other, "DIA_Cedric_Hallo_12_00"); //我 是 剑 术 大 师 塞 德 里 克 ， 国 王 的 圣 骑 士 。
};
...
{
	AI_Output(other, self, "DIA_Cedric_CanTeach_15_00"); //你 能 训 练 我 吗 ？

	if (other.guild == GIL_PAL)
	{
		AI_Output(self, other, "DIA_Cedric_CanTeach_12_01"); //我 可 以 教 你 单 手 武 器 搏 击 术 。
		Cedric_Teach1H = TRUE;
		B_LogEntry(TOPIC_CityTeacher, TOPIC_CityTeacher_22);
	}
	else
	{
		AI_Output(self, other, "DIA_Cedric_CanTeach_12_02"); //我 只 训 练 圣 骑 士 。
	};
};
...
{
	AI_Output(other, self, "DIA_Cedric_Teach_15_00"); //我 要 训 练 。

	if (other.HitChance[NPC_TALENT_1H] >= 90)
	{
		AI_Output(self, other, "DIA_DIA_Cedric_Teach_12_01"); //你 已 经 学 会 了 剑 术 搏 斗 的 所 有 方 法 。 我 没 有 更 多 东 西 可 以 教 你 了 。
	}
	else
	{
