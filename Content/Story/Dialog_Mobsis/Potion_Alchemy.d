...
instance PC_Booze_Schlaf(C_Info)
{
	...
	permanent		= TRUE;
	description		= "加 入 双 倍 朗 姆 酒 后 的 卢 的 海 默 酒";
};
...
instance PC_ItPo_Mana_01(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "魔 力 精 华 （ ２ 火 荨 麻 ， １ 洼 地 节 草 ）";
};
...
instance PC_ItPo_Mana_02(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "魔 力 萃 取 物 （ ２ 柳 兰 ， １ 洼 地 节 草 ） ";
};
...
instance PC_ItPo_Mana_03(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "魔 力 炼 金 药 （ ２ 火 根 ， １ 洼 地 节 草 ）";
};
...
instance PC_ItPo_Mana_04(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "魔 力 药 剂 （ ３ 魔 力 精 华 ， １ 洼 地 节 草 ）";
};
...
instance PC_ItPo_Health_01(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "治 疗 精 华 （ ２ 治 疗 植 物 ， １ 洼 地 节 草 ）";
};
...
instance PC_ItPo_Health_02(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "治 疗 萃 取 物 （ ２ 治 疗 药 草 ， １ 洼 地 节 草 ）";
};
...
instance PC_ItPo_Health_03(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "治 疗 炼 金 药 （ ２ 治 疗 根 ， １ 洼 地 节 草 ）";
};
...
instance PC_ItPo_Health_04(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "治 疗 药 剂 （ ３ 治 疗 精 华 ， １ 洼 地 节 草 ）";
};
...
instance PC_ItPo_Perm_Health(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "生 命 炼 金 药 （ １ 治 疗 根 ， １ 国 王 酢 浆 草 ）";
};
...
instance PC_ItPo_Perm_Mana(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "精 神 炼 金 药 （ １ 火 根 ， １ 国 王 酢 浆 草 ）";
};
...
instance PC_ItPo_Dex(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "敏 捷 药 剂 （ １ 哥 布 林 浆 果 ， １ 国 王 酢 浆 草 ）";
};
...
instance PC_ItPo_Strg(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "力 量 药 剂 （ １ 龙 根 ， １ 国 王 酢 浆 草 ）";
};
...
instance PC_ItPo_Speed(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "速 度 药 剂 （ １ 暴 龙 草 ， １ 洼 地 节 草 ）";
};
...
instance PC_ItMi_Addon_Joint_01(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "制 造 绿 色 新 信 徒 （ １ 支 卷 烟 ）";
};
...
func void PC_ItMi_Tabak_Info()
{
	...
	{
		Info_AddChoice(PC_ItMi_Tabak, "… … 加 入 蜂 蜜", PC_ItMi_Tabak_Honey);
	};

	if (Npc_HasItems(hero, ItPl_SwampHerb) >= 1)
	{
		Info_AddChoice(PC_ItMi_Tabak, "… … 加 入 沼 生 草", PC_ItMi_Tabak_Swampherb);
	};

	if (Npc_HasItems(hero, ItPl_Mushroom_01) >= 1)
	{
		Info_AddChoice(PC_ItMi_Tabak, "… … 加 入 黑 暗 的 蘑 菇", PC_ItMi_Tabak_Mushroom_01);
	};
};
...
instance PC_ItPo_MegaDrink(C_INFO)
{
	...
	permanent		= TRUE;
	description		= "龙 蛋 药 剂 （ １ ０ 龙 蛋 ， １ 黑 珍 珠 ， １ 硫 磺 ）";
};
