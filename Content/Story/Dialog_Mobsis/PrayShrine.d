...
func void PC_PrayShrine_Pray_Info()
{
	...
	else
	{
		...
		Info_AddChoice(PC_PrayShrine_Pray, "我 要 祈 祷 并 捐 献 ０ 枚 金 币 。", PC_PrayShrine_Pray_NoPay);

		if (Npc_HasItems(hero, ItMi_Gold) >= 10)
		{
			Info_AddChoice(PC_PrayShrine_Pray, "我 要 祈 祷 并 捐 献 １ ０ 枚 金 币 。", PC_PrayShrine_Pray_SmallPay);
		};

		if (Npc_HasItems(hero, ItMi_Gold) >= 50)
		{
			Info_AddChoice(PC_PrayShrine_Pray, "我 要 祈 祷 并 捐 献 ５ ０ 枚 金 币 。", PC_PrayShrine_Pray_MediumPay);
		};

		if (Npc_HasItems(hero, ItMi_Gold) >= 100)
		{
			Info_AddChoice(PC_PrayShrine_Pray, "我 要 祈 祷 并 捐 献 １ ０ ０ 枚 金 币 。", PC_PrayShrine_Pray_BigPay);
		};
	};
};
